  ...
  <div class="page about">
    <div class="container">
      ...
      <section class="description">
        ...
        <div class="text">
          Компания ITLABS работает на рынке с 2016 года. Наша компания разделена
          на подразделения: клиентоориентированный менеджмент, тестировщики,
          web-разработчики, frontend-разработчики, backend-разработчики,
          fullstack-разработчики, разработчики программного обеспечения,
          ...
          AxeTech, Intechirs, NexTouch и другими производителями интерактивного
          оборудования.
          <br /><br />
          ...
          <br /><br />
          Компания расширяется, если вы хотите работать в команде сильных
